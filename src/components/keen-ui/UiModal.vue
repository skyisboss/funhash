    ...
    <transition :name="toggleTransition" @after-enter="onEnter" @after-leave="onLeave">
        ...
        >
            ...
            >
                ...
                >
                    <div class="ui-modal__header" :class="headerClass" v-if="!removeHeader">
                        <slot name="header">
...
$ui-modal-mask-background       : rgba(black, 0.4) !default;
...
.ui-modal__mask {
    background-color: var(--modal-mask-color,$ui-modal-mask-background);
    display: table;
    height: 100%;
    left: 0;
    position: fixed;
